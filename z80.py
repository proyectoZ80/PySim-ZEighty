...
class Z80(object):
    ...
    @staticmethod
    def callMethod(object, name, opr, valpc):
        Z80.PC = valpc
        lista = ["JP", "JR", "CALL"]
        print(len(opr))
        if (len(opr) == 0):
    ...
    def checkRegister2(o, name, parameter_list):
        #print("parameter list " + str(parameter_list))
    ...
    def changeFlags(numberInBIN):
        ...
        #numberInDecimal = int(numberInBIN )
        #print("number dec " + str(numberInDecimal))
        #Z80.zero(numberInDecimal)
        #Z80.parity(numberInDecimal)
        #cambiando la bandera N
        Z80.changeFlag(1, "0")
        #cambiando la bandera H
        Z80.changeFlag(4, "0")
    ...
    def RLC8(register):
        ...
        memoria.Memoria.cambiarContenido(content, memoryAddress)
...
## checar denuevo
    ...
    def RLD():
        ...
        print("contenido de la memoria " + content)
        high_order_four_bits = content[:4]
        low_order_four_bits = content[4:]
        print(high_order_four_bits)
        print(low_order_four_bits)
        contentOfA = Z80.hexToBin(Z80.A)
        print("contenido de A " + contentOfA)
        high_order_four_bits_A = contentOfA[:4]
        low_order_four_bits_A = contentOfA[4:]
        print(high_order_four_bits_A)
        print(low_order_four_bits_A)
    ...
    def SET8(parameter_list):
        ...
        memoria.Memoria.cambiarContenido(Z80.binToHex(content), memoryAddress)
